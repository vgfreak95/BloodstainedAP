...
ITEMS_DATA = {
    ...
    "Crystal": RitualItemData(id=0xb101a, name="Crystal", count=52, category=RitualItemCategory.INGREDIENT, classification=ItemClassification.filler),
    ...
    "Zangetsuto": RitualItemData(id=0xb1048, name="Zangetsuto", count=1, category=RitualItemCategory.WEAPON, classification=ItemClassification.useful),
    ...
    "Aegis Plate": RitualItemData(id=0xb1082, name="Aegis Plate", count=1, category=RitualItemCategory.BODY, classification=ItemClassification.useful),
