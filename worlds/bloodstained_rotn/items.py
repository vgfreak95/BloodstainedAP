...
CHEST_AND_WALL_ITEMS = {
    ...
    "Waystone": RitualItemData(id=0xb1011, name="Waystone", count=16 - 11, category=RitualItemCategory.POTION, classification=ItemClassification.useful),
    ...
    "Mahogany": RitualItemData(id=0xb1027, name="Mahogany", count=32 - 16, category=RitualItemCategory.INGREDIENT, classification=ItemClassification.filler),
    ...
    "Alexandrite": RitualItemData(id=0xb102d, name="Alexandrite", count=23 - 12, category=RitualItemCategory.INGREDIENT, classification=ItemClassification.filler),
    ...
    "Silver Bromide": RitualItemData(id=0xb1098, name="Silver Bromide", count=1, category=RitualItemCategory.KEY, classification=ItemClassification.progression),
    "Carpenter's Key": RitualItemData(id=0xb1099, name="Carpenter's Key", count=1, category=RitualItemCategory.KEY, classification=ItemClassification.progression),
    "Warhorse's Key": RitualItemData(id=0xb109a, name="Warhorse's Key", count=1, category=RitualItemCategory.KEY, classification=ItemClassification.progression),
    "Millionaire's Key": RitualItemData(id=0xb109b, name="Millionaire's Key", count=1, category=RitualItemCategory.KEY, classification=ItemClassification.progression),
...
MONEY_ITEMS = {
    # Gold
    "500G": RitualItemData(id=0xb10d4, name="500G", count=8, category=RitualItemCategory.MONEY, classification=ItemClassification.useful),
    "1000G": RitualItemData(id=0xb10d5, name="1000G", count=4, category=RitualItemCategory.MONEY, classification=ItemClassification.useful),
    "2000G": RitualItemData(id=0xb10d6, name="2000G", count=9, category=RitualItemCategory.MONEY, classification=ItemClassification.useful),
}
