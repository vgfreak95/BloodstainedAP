...
class RitualWorld(World):
    ...
    def fill_slot_data(self):
        return self.options.as_dict("drop_experience_multiplier", "drop_item_multiplier", "drop_money_multiplier", "start_inventory", "drop_shard_initial_grade", "drop_shard_multiplier")
